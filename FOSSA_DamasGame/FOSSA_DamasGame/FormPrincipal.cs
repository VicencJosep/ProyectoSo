    ...
    public partial class FormPrincipal : Form
    {
        ...
        private void AtenderServidor()
        {
            while (true)
            {
                ...
                switch (codigo)
                {
                    ...
                    case 5:
                        string respuesta5;
                        //  respuesta5 = "El número de kills que e hicieron en la partida con dificultad" + BoxID.Text + " es :  " + mensaje;//Mensaje
                        // this.Invoke(new DelegadoParaEscribirTexto(PonRespuesta), new object[] { respuesta5 });
                        break;
                    case 6:
                        string respuesta6;
                        if (mensaje == "error")
        ...
        private void PonNotificacion(string notificacion)
        {
            ...
            if (Convert.ToInt32(trozos[0]) == -2)
                notificacionlbl.Text = trozos[1];
            else
            {
                InvitacionLbl.Text = trozos[1] + trozos[2];
        ...
        private void NotificacionInvitacion(string notificacion)
        {
            InvitacionLbl.Text = notificacion;
